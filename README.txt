...
I would like to encapsulate my timing and plotting code into it's own repository, so that I can just include it and not have to write custom testing code for each algorithm or data structure I want to test. Also I could 
